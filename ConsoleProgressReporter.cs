...
{
    //Affiche une barre de progression ASCII dans la console
    public class ConsoleProgressReporter : IProgressReporter
    {
        private int lastPercent = -1;
        private readonly int barWidth = 40; //Largeur de la barre en caractères
        private bool isFirstReport = true;

        //Rapporte la progression avec une barre visuelle, format : [#######.............] 040% - Message
        ...
        //Dessine la barre de progression sur la console
